   ...
   <div class="wrapper">
      <div class="sidebar">
        <ul>
		   ...
		   <li><i><a href="/DE/shopkeeper/register/update.php"><img src="\DE\Logos\profile.png" title="update" width="40" height="40"></a></i></li>
	...
	<div class="balance">
	  <div class="balance-details">
		...
		?>
				...
				<tr>
					<td><?php echo $roow['date'];?></td>
					<td><?php echo $roow['feed_name'];?></td>
					<td><?php echo $roow['feedback'];?></td>
